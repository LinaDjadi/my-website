...
const Portfolio = () => {
  ...
  // --- UPDATED: zoom modal now tracks items array + index ---
  const [zoomModal, setZoomModal] = useState({ isOpen: false, items: [], index: 0 });
  ...
  // --- UPDATED: open with items array and starting index ---
  const openZoomModal = (items, startIndex) => {
    setZoomScale(1);
    setZoomModal({ isOpen: true, items, index: startIndex });
  };

  const closeZoomModal = () => {
    setZoomModal({ isOpen: false, items: [], index: 0 });
    setZoomScale(1);
  };
  ...
  const skillCards = useMemo(
    () => [
      ...
      },
      {
        ...
        items: ["PHP", "Laravel", "PrestaShop", "API Development"],
      },
      {
        title: "Mobile",
        icon: <IconMobile />,
  ...
  // Derive current zoom image/title from state
  const zoomCurrent = zoomModal.items[zoomModal.index] || {};
  const zoomImage = zoomCurrent.image;
  const zoomTitle = zoomCurrent.title;
      ...
      {zoomModal.isOpen && (
        <div className="zoom-modal" onClick={handleModalBackgroundClick} role="dialog" aria-modal="true">
          <div className="zoom-modal-content">
            ...
            {/* --- NEW: Prev/Next arrows inside modal --- */}
            {zoomModal.items.length > 1 && (
              <>
                <button
            ...
            <div className="zoom-modal-footer">
              <p className="zoom-image-title">
                {zoomTitle}
                <span className="zoom-counter">
                  {" "}{zoomModal.index + 1} / {zoomModal.items.length}
                </span>
              </p>
      ...
      <section id="projects" className="projects-section">
        <div className="section-container">
          ...
          <div className="projects-grid">
            ...
            <div className="project-card">
              <div className="project-top">
                <span className="project-chip">PRESTASHOP</span>
              </div>

              <div className="project-body">
                <div className="project-details">
                  <h3 className="project-title">Custom PrestaShop Modules</h3>
                  <p className="project-subtitle">PHP Module Development</p>

                  <p className="project-text">
                    Developed custom PrestaShop modules extending e-commerce functionality. 
                    Built modules for pickup point management, stock return processing, and 
                    refurbished product listings with full back-office integration.
                  </p>

                  <div className="project-tech">
                    <span className="tech-tag">PHP</span>
                    <span className="tech-tag">PrestaShop</span>
                    <span className="tech-tag">MySQL</span>
                    <span className="tech-tag">Back Office</span>
                  </div>

                  <div className="project-features">
                    <h4>Key Modules:</h4>
                    <ul>
                      <li><strong>Pickup Noest</strong> — Custom pickup point selection at checkout</li>
                      <li><strong>Retours Stock</strong> — Automated stock return & refund workflow</li>
                      <li><strong>Produits Reconditionnées</strong> — Refurbished product catalog with grading</li>
                    </ul>
                  </div>
                </div>
